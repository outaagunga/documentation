...
You can also generate the implementation.md using AI. To do so, use AI with capabilities of reading the entire project structure (folders and files within a project)  
